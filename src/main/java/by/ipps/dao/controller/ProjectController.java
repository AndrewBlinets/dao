...
public class ProjectController extends BaseEntityAbstractController<Project, ProjectService>
    ...
    public ResponseEntity<CustomPage<ProjectDto>> getAllForClient(
        ...
        java.lang.reflect.Type targetListType = new TypeToken<CustomPage<ProjectDto>>() {
        }.getType();
    ...
    public ResponseEntity<Page<Project>> getAll(
        ...
        Page<Project> newsPage = service.findNewsPageBySectionAndDepartment(section, department, pageable);
        return new ResponseEntity<>(newsPage, HttpStatus.OK );
    }

    @Override
    public ResponseEntity<Project> get(Long id, String language, Section section, Department department) {
